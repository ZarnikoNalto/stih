...
`).join("<br>");return(n,o)=>(K(),se("div",{class:tt(["poem-card flex w-full flex-col gap-2",{disappearing:n.meta?.disappearing}])},[ae("p",{class:"h-[20%] rounded-2xl bg-transparent font-semibold",style:kt({"text-align-last":n.justify}),innerHTML:t(n.content)},null,12,fu)],2))}}),pu=It(du,[["__scopeId","data-v-0bf9880b"]]),_u=$e({__name:"ScrollProgress",setup(e){const t=he(0),n=()=>{const o=document.documentElement.scrollTop,s=document.documentElement.scrollHeight-document.documentElement.clientHeight;t.value=s>0?o/s*100:0};return un(()=>{window.addEventListener("scroll",n),n();const o=new MutationObserver(()=>{Mt(()=>{n()})});o.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0}),window.__scrollProgressObserver=o}),cn(()=>{window.removeEventListener("scroll",n),window.__scrollProgressObserver&&(window.__scrollProgressObserver.disconnect(),delete window.__scrollProgressObserver)}),(o,s)=>(K(),se("div",{class:"scroll-progress",style:kt({height:t.value+"%"})},null,4))}}),hu=It(_u,[["__scopeId","data-v-e4928b34"]]),ue={"(0)Fate":"./mus/(0)Fate.opus","(1)Voyage":"./mus/(1)Voyage.opus","(1_1)Home":"./mus/(1_1)Home.opus","(1_2)Rachel":"./mus/(1_2)Rachel.opus","(1_3)Amberley":"./mus/(1_3)Amberley.opus","(1_4)Promenade":"./mus/(1_4)Promenade.opus","(1_5)Letters":"./mus/(1_5)Letters.opus","(1_6)When the Love Falls":"./mus/(1_6)When the Love Falls.opus","(1_7)Under the Cover of Night":"./mus/(1_7)Under the Cover of Night.opus","(1_8)Souvenir":"./mus/(1_8)Souvenir.opus","(1_9)Starry Night":"./mus/(1_9)Starry Night.opus","(1_10)Doubts":"./mus/(1_10)Doubts.opus","(1_11)Break":"./mus/(1_11)Break.opus","(1_12)Last Choise":"./mus/(1_12)Last Choise.opus","(1_13)Secret":"./mus/(1_13)Secret.opus","(1_14)Hold Me Please":"./mus/(1_14)Hold Me Please.opus","(1_15)Coward":"./mus/(1_15)Coward.opus","(1_16)Malfaiteur":"./mus/(1_16)Malfaiteur.opus","(1_17)Mistake":"./mus/(1_17)Mistake.opus","(1_18)Fatal Mistake":"./mus/(1_18)Fatal Mistake.opus","(1_19)Empathy":"./mus/(1_19)Empathy.opus","(1_20)Décadence":"./mus/(1_20)Décadence.opus","(1_21)Hopefulness":"./mus/(1_21)Hopefulness.opus"};function C(e){return{text:e[0],justify:"left"}}function I(e){return{text:e[0],justify:"right"}}function Qt(e){return{text:e[0],meta:{disappearing:!0}}}function Le(e){return typeof e=="string"?e:e.text}function Ks(e){return typeof e=="string"?void 0:e.meta}function je(e){return typeof e=="string"?void 0:e.justify}const U=(e=void 0,t="center",n={})=>(o,s,l)=>{const a=Le(o),c=je(o)??(typeof t=="function"?t(o,s,l):t??"center"),f=Ks(o)??(typeof n=="function"?n(o,s,l):n??void 0);return{text:a,visible:!1,hasButton:s==l.length-1,justify:c,newSong:e,meta:f}},mu=[{id:"beginning",next:"neutral-0",text:`Вчера студент, сегодня – безработный доктор,
  ...
  Сегодня я с ней поборюсь… `].map((e,t,n)=>({text:e,visible:!1,hasButton:t==n.length-1,id:`neutral-${t+wr.length}`,justify:"center",next:t==n.length-1?[{id:"brave-0",label:"Храбрец",song:ue["(1)Voyage"],brigtness:1.2},{id:"fear-0",label:"Страх",song:ue["(1_15)Coward"],brigtness:.8}]:`neutral-${t+wr.length+1}`})),vu=[`…Страх победил. Я снова испугался.
  ...
  А он надеялся спастись, дурной калека.`].map(U()),yu=[...vu,...bu].map((e,t,n)=>({...e,id:`fear-${t}`,next:t==n.length-1?[{id:"fear-ignore-0",label:"Плевать",song:ue["(1_16)Malfaiteur"],brigtness:.6},{id:"fear-help-0",label:"Помочь",song:ue["(1_19)Empathy"],brigtness:1}]:`fear-${t+1}`})),wu=[`Но я плевать хотел. Его проблемы – мусор.
...
Вдруг где-то на дне есть монета?`].map(U()),Tu=[`«Твою ж!…» - я срываюсь на жалобный крик,
  ...
  Способен ли я убивать?`].map(U()),xu=[...wu,...Au,...Tu].map((e,t,n)=>({...e,id:`fear-ignore-${t}`,next:t==n.length-1?[{id:"fear-ignore-keep-0",label:"Оставлю",song:ue["(1_17)Mistake"],brigtness:.4},{id:"fear-ignore-sell-0",label:"Продам",brigtness:.6}]:`fear-ignore-${t+1}`})),Su=[`Оставлю себе.
  ...
  Вдали увидел Эмберли…`].map((e,t,n)=>({text:e,visible:!1,hasButton:t==n.length-1,newSong:ue["(1_1)Home"],justify:"center"})),Vu=["<…>",`Я помню улицу… Я помню этот дом.
  ...
  Хоть познакомлюсь с новыми людьми.`].map((e,t,n)=>({text:e,visible:!1,hasButton:t==n.length-1,newSong:ue["(1_2)Rachel"],justify:"center"})),Gu=[`Стучусь… И с замиранием сердца жду ответа.
  ...
  Я двинулся туда, где жил мясник.`].map((e,t,n)=>({text:Le(e),visible:!1,hasButton:t==n.length-1,newSong:ue["(1_3)Amberley"],justify:je(e)??"center"})),Ku=[`В деревне центр свой – не городская площадь,
  ...
  Все эти чувства укреплял.`].map((e,t,n)=>({text:Le(e),visible:!1,hasButton:t==n.length-1,newSong:ue["(1_4)Promenade"],justify:je(e)??"center"})),qu=[`И вдруг… Толчок! Опять в плечо,
...
Ну а затем держись меня.»`].map((e,t,n)=>({text:Le(e),visible:!1,hasButton:t==n.length-1,newSong:ue["(1_5)Letters"],justify:je(e)??"center"})),Ju=["<…>",`Затеи Рейчел мне всегда казались чудом.
  ...
  Мне диалог наш мысль дал одну…`,I`«Ты ведь с животными в приятельских речах?»`].map((e,t,n)=>({text:Le(e),visible:!1,hasButton:t==n.length-1,justify:je(e)??"center"})),Qu=["<…>",`Весь новый день провёл я в предвкушении –
    ...
    Могла с ним слиться, ей лишь захотеть…`].map((e,t,n)=>({text:e,visible:!1,hasButton:t==n.length-1,newSong:ue["(1_6)When the Love Falls"],justify:"center"})),ec=["<…>",`Стук в дверь – и я, как окрылённый ворон,
  ...
  Но так слова мы сбережём.`].map(U()),oc=[`Земля сменилася травою,
  ...
  Мы к клёну сели впопыхах.`].map(U()),sc=["<…>",C`«Что, если мы когда-то сможем
  ...
  Теперь пора и в хлев сходить.`].map(U(ue["(1_7)Under the Cover of Night"])),ic=["<…>",C`«Ты правда думаешь, что сможешь?»`,I`«Ну я хотя бы посмотрю!»`,C`«Звучит всё как-то, ну, не очень.
  ...
  И я заснул, как на убой.`].map(U(ue["(1_8)Souvenir"])),cc=["<…>",`Мне каждый день казался первым,
  ...
  А вдруг её мои стремления напугают?`].map(U()),dc=[...ju,...Vu,...Gu,...Wu,...Ku,...Uu,...qu,...Yu,...Xu,...zu,...Ju,...Zu,...Qu,...ec,...tc,...nc,...rc,...oc,...sc,...ic,...lc,...ac,...uc,...cc,...fc].map((e,t,n)=>({...e,id:`brave-${t}`,next:t==n.length-1?[{id:"brave-tell-0",label:"Сказать",song:ue["(1_9)Starry Night"],brigtness:1.4},{id:"brave-keep-0",label:"Хранить",song:ue["(1_13)Secret"],brigtness:1}]:`brave-${t+1}`})),pc=[`И пусть. Сказать, как есть – не страшно,
  ...
  Она – мой свет. Я с ней живой.`].map(U(ue["(1_10)Doubts"])),hc=["<…>",`Проходит время. И с зимою
  ...
  Меня сжигало и во сне.`].map(U()),mc=[...pc,..._c,...hc].map((e,t,n)=>({...e,id:`brave-tell-${t}`,next:t==n.length-1?[{id:"brave-tell-doubt-0",label:"Сомневаться",brigtness:.8},{id:"brave-tell-talk-0",label:"Разговор",song:ue["(1_11)Break"],brigtness:1.6}]:`brave-tell-${t+1}`})),gc=[`Сомнения гложут. Мне не победить их.
  ...
  Хотелось то ли выть, то ли кричать.`].map(U()),yc=[...vc,...bc].map((e,t,n)=>({...e,id:`brave-tell-talk-${t}`,next:t==n.length-1?[{id:"brave-tell-talk-leave-0",label:"Уеду",brigtness:.8},{id:"brave-tell-talk-stay-0",label:"Останусь",song:ue["(1_12)Last Choise"],brigtness:1.6}]:`brave-tell-talk-${t+1}`})),wc=[`Уеду в город. Не смогу я больше
  ...
  На улице всё холодней.`].map(U()),Ec=[...kc,...Ic].map((e,t,n)=>({...e,id:`brave-keep-${t}`,next:t==n.length-1?[{id:"brave-keep-leave-0",label:"Уеду",brigtness:.8},{id:"brave-keep-stay-0",label:"Останусь",song:ue["(1_14)Hold Me Please"],brigtness:1.2}]:`brave-keep-${t+1}`})),$c=[`Уеду прочь. Но не за ней, а дальше,
...
Пора впитать мне улицы покой.`].map((e,t,n)=>({text:e,visible:!1,hasButton:t==n.length-1,justify:"center"})),Pc=[`Я выхожу, мороз вдыхаю кожей –
  ...
  Чтоб развести собою твою грусть.»`].map(U()),Oc=[...Mc,...Pc].map((e,t,n)=>({...e,id:`brave-keep-stay-${t}`,next:t==n.length-1?[{id:"TRY_AGAIN",label:"Попробовать еще раз?",ending:"1.2.2 - Время"}]:`brave-keep-stay-${t+1}`})),Fc=[...mu,...wr,...gu,...yu,...xu,...Eu,...Du,...Nu,...$u,...Lu,...dc,...mc,...gc,...yc,...wc,...Ac,...Sc,...Cc,...Ec,...$c,...Oc],Bc=Object.fromEntries(Fc.map(e=>[e.id,e]));function yt(e){return new Promise(t=>setTimeout(t,e))}const Lc={class:"fixed top-0 left-0 z-1 h-10 w-full bg-[image:var(--secondary-gradient)]"},Hc={class:"flex flex-col items-center p-2"},Rc={class:"absolute top-[50%] translate-y-[-50%]"},Dc={key:0,class:"absolute top-[50%] flex h-[50vh] w-[50%] -translate-y-1/2 flex-col items-center justify-center"},Nc=["id"],jc=$e({__name:"App",setup(e){const t=he(void 0),n=he(Bc),o=Tt([]),s=he(),l=he(),a=he(),c=Tt([]),f=Tt(new Set),_=Tt(new Set),p=he(!1),r=he(!1),i=he(!1),u=he(),d=he(),g=he(1),b=Ls(()=>`brightness(${g.value})`),T={prod:{showNext:600}}.prod,F=async L=>{const k=n.value[L];k.visible=!0,o.push(k),"hasButton"in k&&!k.hasButton?(clearTimeout(t.value),t.value=setTimeout(()=>F(k.next),T.showNext)):t.value=void 0},M=L=>{console.log("handling end"),tu(L),d.value?.update()},W=async()=>{g.value=1;const L=["brave-0","fear-0"],k=u.value?.findIndex(ee=>L.map(J=>`block-${J}`).includes(ee.id)),N=o.findIndex(ee=>L.includes(ee.id)),G=c.findIndex(ee=>L.includes(ee));if(console.log(u.value?.map(ee=>ee.id)),console.log(k),!k||k==-1)throw new Error("For some reason i can't find Brave or Fear block");if(N==-1)throw new Error("For some reason i can't find Brave or Fear block");if(G==-1)throw new Error("For some reason i can't find Brave or Fear choose");c.splice(G),f.clear(),_.clear(),await Mt();const _e=u.value?.[k-1];console.log(_e),_e?.scrollIntoView({behavior:"smooth",block:"end"}),await yt(300),o.splice(N),l.value="./mus/(0)Fate.opus"},ne=async(L,k,N="single",G=void 0,_e=void 0,ee=void 0)=>{if(console.log(L),(L=="THE_END"||L=="TRY_AGAIN")&&_e!=null){console.log(_e),M(_e),L=="TRY_AGAIN"&&W();return}if(ee&&(g.value=ee),!c.includes(L))if(c.push(L),G&&(l.value=G),N=="multiple"){const J=`btn-${L}`;console.log("Multiple choice - Looking for button:",J),console.log("Available buttons:",a.value?.map(we=>we.$el.id));const Y=a.value?.find(we=>we.$el.id===J);console.log("Found button:",Y),Y?(await yt(150),console.log("Scrolling to button"),Y.$el.scrollIntoView({behavior:"smooth",block:"center"})):console.warn("Button not found for scrolling!"),await yt(500),_.add(k),await yt(1e3),f.add(L),F(L),await Mt()}else{F(L),await Mt();const J=`btn-${L}`;console.log("Single choice - Looking for button:",J),console.log("Available buttons:",a.value?.map(we=>we.$el.id));const Y=a.value?.find(we=>we.$el.id===J);console.log("Found button:",Y),Y?(await yt(150),console.log("Scrolling to button"),Y.$el.scrollIntoView({behavior:"smooth",block:"start"})):console.warn("Button not found for scrolling!")}},ce=async()=>{r.value=!0,await yt(2e3),r.value=!1,await yt(500),l.value=ue["(0)Fate"],n.value.beginning.visible=!0,o.push(n.value.beginning),p.value=!0,await Mt(),s.value?.play()},de=L=>c?.includes(L),B=L=>!L.hasButton||!L.visible?!1:L.next instanceof Array?!L.next.some(k=>f.has(k.id)):!f.has(L.next),q=()=>g.value<=.6;return un(()=>{window.scrollTo({top:0})}),(L,k)=>(K(),se("div",{ref:"body",class:tt(["body hide-scrollbar pt-10",{inverted:q()}])},[ae("header",Lc,[ie(An,{name:"fade"},{default:ct(()=>[p.value?(K(),Re(qa,{key:0,ref_key:"audioPlayer",ref:s,src:l.value},null,8,["src"])):xt("",!0)]),_:1})]),ae("main",Hc,[ae("div",Rc,[ie(An,{name:"fade",onAfterLeave:ce},{default:ct(()=>[i.value?xt("",!0):(K(),Re(So,{key:0,class:"",onClick:k[0]||(k[0]=N=>i.value=!0)},{default:ct(()=>[...k[1]||(k[1]=[Fn(" Начать ",-1)])]),_:1}))]),_:1})]),ie(An,{name:"fade"},{default:ct(()=>[r.value?(K(),se("div",Dc,[k[2]||(k[2]=ae("h2",{class:"p-8"}," Этот сайт активно использует звук для создания подходящей атмосферы. Пожалуйста, используйте наушники. ",-1)),ie(He(Oa),{size:40})])):xt("",!0)]),_:1}),ie(ga,{name:"fade",tag:"div",class:"content-wrapper"},{default:ct(()=>[(K(!0),se(me,null,$n(o,N=>(K(),se("div",{id:`block-${N.id}`,key:N.id,ref_for:!0,ref_key:"blockElements",ref:u,class:"block-container flex flex-col items-center justify-center"},[ie(pu,{content:N.text,justify:N.justify,meta:N.meta,class:"p-2"},null,8,["content","justify","meta"]),B(N)?(K(),se("div",{key:0,class:tt(["choose-holder flex flex-row items-center justify-center gap-x-48 p-8",{collapsing:_.has(N.id)}])},[N.next instanceof Array?(K(!0),se(me,{key:1},$n(N.next,G=>(K(),Re(So,{key:G.id,id:`btn-${G.id}`,ref_for:!0,ref_key:"buttons",ref:a,class:tt(["anim-btn",{selected:de(G.id)}]),inverted:q(),onClick:_e=>ne(G.id,N.id,"multiple",G.song,G.ending,G.brigtness)},{default:ct(()=>[Fn(xn(G.label),1)]),_:2},1032,["id","class","inverted","onClick"]))),128)):(K(),Re(Qa,{key:0,id:`btn-${N.next}`,ref_for:!0,ref_key:"buttons",ref:a,onClick:G=>ne(N.next,N.id,"single",N.newSong)},null,8,["id","onClick"]))],2)):xt("",!0)],8,Nc))),128))]),_:1}),k[3]||(k[3]=ae("div",{class:"scroll-spacer"},null,-1))]),ie(cu,{ref_key:"endingIndicator",ref:d},null,512),ae("div",{class:"background",style:kt({filter:b.value})},null,4),ie(hu)],2))}}),Vc=It(jc,[["__scopeId","data-v-8d3eb9d3"]]);xa(Vc).mount("#app");
