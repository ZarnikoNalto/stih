import{d as L,m as he,u as me,c as p,o as f,a as w,n as C,_ as P,r as _,F as G,b as Y,e as N,f as y,g as F,t as q,h as oe,i as ie,j as T,k as ge,l as R,p as _e,q as ye,w as E,s as J,v as se,B as ae,T as ne,x as ke}from"./index-DyzBmnN_.js";import{_ as we,C as $e}from"./ChooseBtn-Dp4PmqXh.js";const D=["1.1.1 - Сомнения","1.1.2.1 - Память","1.1.2.2.1 - Любовь","1.1.2.2.2 - Обида","1.2.1 - Забвение","1.2.2 - Время","2.2.1 - Боль","2.2.2 - Меланхолия","2.1.1 - Надежда","2.1.2 - Отчаяние"],re="ENDINGS";function O(){const t=localStorage.getItem(re);if(!t)return[];const e=JSON.parse(t);return[...new Set(e)]}function Be(t){localStorage.setItem(re,JSON.stringify(t))}function je(t){const e=O();e.push(t),Be(e)}const Se=["checked","disabled"],Ae=L({__name:"Bubble",props:he({size:{default:void 0},locked:{type:Boolean,default:!1}},{checked:{type:Boolean,default:!1},checkedModifiers:{}}),emits:["update:checked"],setup(t){const e=me(t,"checked");return(s,c)=>(f(),p("label",null,[w("input",{value:"on",name:"dummy",type:"checkbox",class:C(["bubble",s.size]),checked:e.value,disabled:s.locked},null,10,Se)]))}}),le=P(Ae,[["__scopeId","data-v-2c5c2db1"]]),Ie={class:"fixed top-12 flex w-full flex-row justify-between px-2"},Ee={class:"flex flex-col items-center justify-center gap-y-1"},Ne={key:0,class:"description cursor-default"},Te={class:"flex flex-col items-center justify-center gap-y-1"},Ce={key:0,class:"description cursor-default"},Fe=L({__name:"EndingIndicator",setup(t,{expose:e}){const s=_(O());e({update:()=>s.value=O()});const c=v=>v.split("-").at(-1)?.trim();return(v,g)=>(f(),p("div",Ie,[w("div",Ee,[(f(!0),p(G,null,Y(N(D).slice(0,N(D).length/2),b=>(f(),p("div",{key:b,class:"goal flex w-full flex-row items-center justify-start gap-x-2"},[y(le,{class:"bubble-wrapper",checked:s.value.includes(b),locked:"",size:"smaller"},null,8,["checked"]),s.value.includes(b)?(f(),p("p",Ne,q(c(b)),1)):F("",!0)]))),128))]),w("div",Te,[(f(!0),p(G,null,Y(N(D).slice(N(D).length/2),b=>(f(),p("div",{key:b,class:"goal flex w-full flex-row items-center justify-end gap-x-2"},[s.value.includes(b)?(f(),p("p",Ce,q(c(b)),1)):F("",!0),y(le,{class:"bubble-wrapper",checked:s.value.includes(b),locked:"",size:"smaller"},null,8,["checked"])]))),128))])]))}}),Me=P(Fe,[["__scopeId","data-v-f20a463a"]]),Le=["innerHTML"],Pe=L({__name:"PoemCard",props:{content:{},justify:{default:"justify"},meta:{default:void 0},monoFont:{type:Boolean,default:!1}},setup(t){const e=s=>s.split(`
`).join("<br>");return(s,c)=>(f(),p("div",{class:C(["poem-card flex w-full flex-col gap-2",{disappearing:s.meta?.disappearing}])},[w("p",{class:"h-[20%] rounded-2xl bg-transparent",style:oe({textAlign:s.justify=="auto"?void 0:s.justify,textAlignLast:s.justify=="auto"?void 0:s.justify,fontFamily:s.monoFont?"var(--font-mono)":"var(--font-serif)"}),innerHTML:e(s.content)},null,12,Le)],2))}}),Ve=P(Pe,[["__scopeId","data-v-c3af39c6"]]),He=L({__name:"ScrollProgress",setup(t){const e=_(0);let s;const c=()=>{const v=document.documentElement.scrollTop,g=document.documentElement.scrollHeight-document.documentElement.clientHeight;e.value=g>0?v/g*100:0};return ie(()=>{window.addEventListener("scroll",c),c(),s=new MutationObserver(()=>{T(()=>{c()})}),s.observe(document.body,{childList:!0,subtree:!0,attributes:!0,characterData:!0})}),ge(()=>{window.removeEventListener("scroll",c),s?.disconnect()}),(v,g)=>(f(),p("div",{class:"scroll-progress",style:oe({height:e.value+"%"})},null,4))}}),Re=P(He,[["__scopeId","data-v-bf96d59f"]]),i={"(0)Fate":"./mus/variabilis/(0)Fate.opus","(1)Voyage":"./mus/variabilis/(1)Voyage.opus","(1_1)Home":"./mus/variabilis/(1_1)Home.opus","(1_2)Rachel":"./mus/variabilis/(1_2)Rachel.opus","(1_3)Amberley":"./mus/variabilis/(1_3)Amberley.opus","(1_4)Promenade":"./mus/variabilis/(1_4)Promenade.opus","(1_5)Letters":"./mus/variabilis/(1_5)Letters.opus","(1_6)When the Love Falls":"./mus/variabilis/(1_6)When the Love Falls.opus","(1_7)Under the Cover of Night":"./mus/variabilis/(1_7)Under the Cover of Night.opus","(1_8)Souvenir":"./mus/variabilis/(1_8)Souvenir.opus","(1_9)Starry Night":"./mus/variabilis/(1_9)Starry Night.opus","(1_10)Doubts":"./mus/variabilis/(1_10)Doubts.opus","(1_11)Break":"./mus/variabilis/(1_11)Break.opus","(1_12)Last Choise":"./mus/variabilis/(1_12)Last Choise.opus","(1_13)Secret":"./mus/variabilis/(1_13)Secret.opus","(1_14)Hold Me Please":"./mus/variabilis/(1_14)Hold Me Please.opus","(1_15)Coward":"./mus/variabilis/(1_15)Coward.opus","(1_16)Malfaiteur":"./mus/variabilis/(1_16)Malfaiteur.opus","(1_17)Mistake":"./mus/variabilis/(1_17)Mistake.opus","(1_18)Fatal Mistake":"./mus/variabilis/(1_18)Fatal Mistake.opus","(1_19)Empathy":"./mus/variabilis/(1_19)Empathy.opus","(1_20)Décadence":"./mus/variabilis/(1_20)Décadence.opus","(1_21)Hopefulness":"./mus/variabilis/(1_21)Hopefulness.opus"};function a(t){return{text:t[0],justify:"left"}}function n(t){return{text:t[0],justify:"right"}}function M(t){return{text:t[0],meta:{disappearing:!0}}}function h(t){return typeof t=="string"?t:t.text}function ce(t){return typeof t=="string"?void 0:t.meta}function m(t){return typeof t=="string"?void 0:t.justify}const l=(t=void 0,e="center",s={})=>(c,v,g)=>{const b=h(c),j=m(c)??(typeof e=="function"?e(c,v,g):e??"center"),B=ce(c)??(typeof s=="function"?s(c,v,g):s??void 0);return{text:b,visible:!1,hasButton:v==g.length-1,justify:j,newSong:t,meta:B}},De=[{id:"beginning",next:"neutral-0",text:`Вчера студент, сегодня – безработный доктор,
...
Вдруг где-то на дне есть монета?`].map(l()),Ue=[`«Твою ж!…» - я срываюсь на жалобный крик,
  ...
  Вдали увидел Эмберли…`].map((t,e,s)=>({text:t,visible:!1,hasButton:e==s.length-1,newSong:i["(1_1)Home"],justify:"center"})),pt=["<…>",`Я помню улицу… Я помню этот дом.
  ...
  Неужто Лондон тяготит?»`].map(l()),vt=[`Она меня читала, будто книгу
  ...
  Я двинулся туда, где жил мясник.`].map((t,e,s)=>({text:h(t),visible:!1,hasButton:e==s.length-1,newSong:i["(1_3)Amberley"],justify:m(t)??"center"})),bt=[`В деревне центр свой – не городская площадь,
...
Пора впитать мне улицы покой.`].map((t,e,s)=>({text:t,visible:!1,hasButton:e==s.length-1,justify:"center"})),ss=[`Я выхожу, мороз вдыхаю кожей –
  ...
  Чтоб развести собою твою грусть.»`].map(l()),as=[...ts,...ss].map((t,e,s)=>({...t,id:`brave-keep-stay-${e}`,next:e==s.length-1?[{id:"TRY_AGAIN",label:"Попробовать еще раз?",ending:"1.2.2 - Время"}]:`brave-keep-stay-${e+1}`})),ns=[...De,...Q,...Ge,...ze,...Je,...Ze,...ct,...ut,...et,...ot,...Pt,...Dt,...Gt,...zt,...Kt,...Wt,...qt,...Ot,...Zt,...es,...as],ls=Object.fromEntries(ns.map(t=>[t.id,t]));function $(t){return new Promise(e=>setTimeout(e,t))}const os={class:"flex flex-col items-center p-2"},is={class:"absolute top-[50%] translate-y-[-50%]"},rs={key:0,class:"absolute top-[50%] flex h-[50vh] w-[50%] -translate-y-1/2 flex-col items-center justify-center"},cs=["id"],us=L({__name:"Variabilis",setup(t){const e=_(void 0),s=_(ls),c=R([]),{currentSong:v,showAudioPlayer:g,audioPlayer:b}=_e(),{brightness:j}=ye(),B=_(),S=R([]),V=R(new Set),x=R(new Set),z=_(!1),X=_(!1),K=_(),Z=_(),ue={prod:{showNext:600}}.prod,W=async o=>{const r=s.value[o];r.visible=!0,c.push(r),"hasButton"in r&&!r.hasButton?(clearTimeout(e.value),e.value=setTimeout(()=>W(r.next),ue.showNext)):e.value=void 0},fe=o=>{je(o),Z.value?.update()},pe=async()=>{j.value=1;const o=["brave-0","fear-0"],r=K.value?.findIndex(k=>o.map(A=>`block-${A}`).includes(k.id)),u=c.findIndex(k=>o.includes(k.id)),d=S.findIndex(k=>o.includes(k));if(!r||r==-1)throw new Error("For some reason i can't find Brave or Fear block");if(u==-1)throw new Error("For some reason i can't find Brave or Fear block");if(d==-1)throw new Error("For some reason i can't find Brave or Fear choose");S.splice(d),V.clear(),x.clear(),await T(),K.value?.[r-1]?.scrollIntoView({behavior:"smooth",block:"end"}),await $(300),c.splice(u),v.value=i["(0)Fate"]},ee=async(o,r,u="single",d=void 0,H=void 0,k=void 0)=>{if((o=="THE_END"||o=="TRY_AGAIN")&&H!=null){fe(H),o=="TRY_AGAIN"&&pe();return}if(k&&(j.value=k),!S.includes(o))if(S.push(o),d&&(v.value=d),u=="multiple"){const A=`btn-${o}`,I=B.value?.find(U=>U.$el.id===A);I?(await $(150),I.$el.scrollIntoView({behavior:"smooth",block:"center"})):console.warn("Button not found for scrolling!"),await $(500),x.add(r),await $(1e3),V.add(o),W(o),await T()}else{W(o),await T();const A=`btn-${o}`,I=B.value?.find(U=>U.$el.id===A);I?(await $(150),I.$el.scrollIntoView({behavior:"smooth",block:"start"})):console.warn("Button not found for scrolling!")}},de=async()=>{z.value=!0,await $(2e3),z.value=!1,await $(500),v.value=i["(0)Fate"],s.value.beginning.visible=!0,c.push(s.value.beginning),g.value=!0,await T(),b.value?.play()},ve=o=>S?.includes(o),be=o=>!o.hasButton||!o.visible?!1:o.next instanceof Array?!o.next.some(r=>V.has(r.id)):!V.has(o.next),te=()=>j.value<=.6;return ie(()=>{window.scrollTo({top:0})}),(o,r)=>(f(),p("div",{ref:"body",class:C(["body hide-scrollbar pt-10",{inverted:te()}])},[w("div",os,[w("div",is,[y(ne,{name:"fade",onAfterLeave:de},{default:E(()=>[X.value?F("",!0):(f(),J(ae,{key:0,class:"",onClick:r[0]||(r[0]=u=>X.value=!0)},{default:E(()=>[...r[1]||(r[1]=[se(" Начать ",-1)])]),_:1}))]),_:1})]),y(ne,{name:"fade"},{default:E(()=>[z.value?(f(),p("div",rs,[r[2]||(r[2]=w("h2",{class:"p-8"}," Этот сайт активно использует звук для создания подходящей атмосферы. Пожалуйста, используйте наушники. ",-1)),y(N(we),{size:40})])):F("",!0)]),_:1}),y(ke,{name:"fade",tag:"div",class:"content-wrapper"},{default:E(()=>[(f(!0),p(G,null,Y(c,u=>(f(),p("div",{id:`block-${u.id}`,key:u.id,ref_for:!0,ref_key:"blockElements",ref:K,class:"block-container flex flex-col items-center justify-center"},[y(Ve,{content:u.text,justify:u.justify,meta:u.meta,class:"p-2 font-semibold","mono-font":""},null,8,["content","justify","meta"]),be(u)?(f(),p("div",{key:0,class:C(["choose-holder flex flex-row items-center justify-center gap-x-48 p-8",{collapsing:x.has(u.id)}])},[u.next instanceof Array?(f(!0),p(G,{key:1},Y(u.next,d=>(f(),J(ae,{key:d.id,id:`btn-${d.id}`,ref_for:!0,ref_key:"buttons",ref:B,class:C(["anim-btn",{selected:ve(d.id)}]),inverted:te(),onClick:H=>ee(d.id,u.id,"multiple",d.song,d.ending,d.brightness)},{default:E(()=>[se(q(d.label),1)]),_:2},1032,["id","class","inverted","onClick"]))),128)):(f(),J($e,{key:0,id:`btn-${u.next}`,ref_for:!0,ref_key:"buttons",ref:B,onClick:d=>ee(u.next,u.id,"single",u.newSong)},null,8,["id","onClick"]))],2)):F("",!0)],8,cs))),128))]),_:1}),r[3]||(r[3]=w("div",{class:"scroll-spacer"},null,-1))]),y(Me,{ref_key:"endingIndicator",ref:Z},null,512),y(Re)],2))}}),vs=P(us,[["__scopeId","data-v-4c04ed29"]]);export{vs as default};
